<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NWTemplate.aspx.cs" Inherits="NewWorldRoster.NWTemplate" %>
...
<table style="margin:0 auto" class="auto-style1">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox 10 ID ="NWCName" runat="server" Width="250px" OnTextChanged="NWServer_TextChanged" />
        </td>
    ...
    <tr>
        ...
        <asp:Button ID="NWSubmit" runat="server" Text="Submit" OnClick="NWSubmitButton_Click" />
